...
from quangstation.core.io.dicom_constants import *  # Import các hằng số DICOM
...
from quangstation.core.data_models.plan_data import PlanConfig, BeamConfig, PrescriptionConfig, TechniqueType, RadiationType
    ...
    def extract_rt_structure(self, referenced_image: Optional[ImageData] = None) -> Optional[StructureSet]:
        ...
        try:
            ...
            if referenced_image:
                ...
                # ref_series không được sử dụng nhưng giữ lại để tham khảo trong tương lai
